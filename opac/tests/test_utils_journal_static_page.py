...
class UtilsJournalPagesTestCase(BaseTestCase):
    ...
    def test_rbep_get_journal_page_img_paths(self):
        ...
        images_in_file.append(PATH+'rbep/CNPq logo.gif')
        journal_img_paths = src.get_journal_page_img_paths(images_in_file)
        ...
        images_in_file.append(PATH+'rbep/logo.gif')
        expected.append((PATH+'rbep/logo.gif',
        ...
        images_in_file.append(PATH+'rbep/nao_existe.gif')
        journal_img_paths = src.get_journal_page_img_paths(images_in_file)
